  ...
  const handleClickDelete = (id) => {
    apiService
      ...
      .then((res) => {
        ...
        const updateTeams = teams.filter((team) => team.id !== id);
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
              ...
              {teams.map((team, index) => (
                  <tr key={index}>
                    ...
                    <img className="rounded-lg max-w-24 w-full object-cover" src={team.imageUrl} alt="" />
                    </td>
                    ...
                    <td className="px-6 py-4 flex gap-1 justify-evenly flex-wrap text-end text-sm font-medium">
                      ...
                      <button
                        ...
                        onClick={() => handleClickEdit(team.id)}
                      >
                      ...
                      <button
                        ...
                        onClick={() => handleClickDelete(team.id)}
                      >
